...
import { ArrowRight, Users, TrendingUp, Shield, Award, Target, Heart, Building2, Handshake, Phone, Calendar, Clock, MapPin, Mail, CheckCircle, Star, ThumbsUp, Eye ,Zap, Globe, Lock } from 'lucide-react';
...
const Index = () => {
  ...
  const values = [
    ...
    },
    {
      icon: Heart,
      title: "Transparency",
      description: "We operate in a clear, open, and honest manner with all stakeholders."
    },
    {
      icon: TrendingUp,
      title: "Reliability",
      description: "We are dependable and consistent in delivering on our promises."
    },
    {
      icon: Handshake,
      title: "Professionalism",
      description: "We conduct ourselves with skill, good judgment, and polite behavior."
    },
    {
      icon: CheckCircle,
...
<section className="py-24 bg-white">
  <div className="container mx-auto px-4">
    ...
    <div className="text-center mb-16">
      <h2 className="text-4xl font-bold text-helb-green-800">Vision, Mission & Core Values</h2>
    ...
    <div className="grid md:grid-cols-2 gap-8 mb-20">
      <div className="bg-gradient-to-r from-helb-green-600 to-helb-green-700 text-white p-8 rounded-xl shadow-lg">
        ...
        <p className="leading-relaxed text-lg">
          To be the preferred financial solutions provider for the members.
        </p>
      </div>
      ...
      <div className="bg-gradient-to-r from-helb-gold-500 to-helb-gold-600 text-white p-8 rounded-xl shadow-lg">
        ...
        <p className="leading-relaxed text-lg">
          Socio-economic empowerment of members through mobilization and provision of superior financial products and services.
        </p>
      </div>
    </div>
    ...
    <div className="grid md:grid-cols-2 gap-16 items-center mb-20">
      ...
      <div className="space-y-6 animate-on-scroll slide-in-right">
        <h3 className="text-2xl font-semibold text-helb-green-800 mb-6">Our Core Values</h3>
        <div className="grid gap-4">
          {[
            {
              icon: Shield,
              title: "Integrity",
              description: "We uphold honesty and transparency in all dealings."
            },
            {
              icon: CheckCircle,
              title: "Accountability",
              description: "We take responsibility for our actions and services."
            },
            {
              icon: Eye,
              title: "Transparency",
              description: "We operate in an open and clear manner to build trust."
            },
            {
              icon: ThumbsUp,
              title: "Reliability",
              description: "You can depend on us to deliver consistent value."
            },
            {
              icon: Users,
              title: "Professionalism",
              description: "We maintain high standards and ethics in everything we do."
            }
          ].map((value, index) => (
            <div
              key={index}
    ...
    <div className="text-center mt-16">
      <p className="text-2xl text-helb-green-800 font-bold italic">“Together for Prosperity.”</p>
    </div>
  </div>
</section>
...
<section className="py-24 bg-gradient-to-br from-gray-50 to-gray-100">
  <div className="container mx-auto px-4">
    <div className="text-center mb-20 animate-on-scroll">
      <h2 className="text-5xl font-bold text-helb-green-800 mb-6">Products & Services</h2>
      <p className="text-xl text-gray-600 max-w-4xl mx-auto">
        Discover our comprehensive range of financial products designed to meet your needs and help you achieve your financial goals.
      </p>
    </div>
        ...
        {services.map((service, index) => (
          ...
          >
            ...
            <CardContent className="p-8">
              <h3 className="text-2xl font-semibold text-helb-green-800 mb-4">{service.title}</h3>
        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="animate-on-scroll slide-in-right">
              <h2 className="text-5xl font-bold text-helb-green-800 mb-8">Leadership & Governance</h2>
              <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                Our experienced leadership team and robust governance structure ensure 
                transparency, accountability, and strategic direction in all our operations.
              </p>
              <div className="space-y-6">
                <div className="flex items-center space-x-4 p-4 bg-white rounded-lg shadow-md">
                  <Building2 className="w-8 h-8 text-helb-green-600" />
                  <div>
                    <h4 className="font-semibold text-gray-800">Board of Directors</h4>
                    <p className="text-gray-600">Strategic oversight and governance</p>
                  </div>
                </div>
                <div className="flex items-center space-x-4 p-4 bg-white rounded-lg shadow-md">
                  <Users className="w-8 h-8 text-helb-green-600" />
                  <div>
                    <h4 className="font-semibold text-gray-800">Management Team</h4>
                    <p className="text-gray-600">Operational excellence and execution</p>
                  </div>
                </div>
                <div className="flex items-center space-x-4 p-4 bg-white rounded-lg shadow-md">
                  <Shield className="w-8 h-8 text-helb-green-600" />
                  <div>
                    <h4 className="font-semibold text-gray-800">Supervisory Committee</h4>
                    <p className="text-gray-600">Compliance and risk management</p>
                  </div>
                </div>
              </div>
              <Link to="/leadership">
    ...
    <div className="grid md:grid-cols-2 gap-16 items-center">
      ...
      <section className="py-24 bg-gradient-to-br from-helb-green-800 to-helb-green-900 text-white">
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="animate-on-scroll slide-in-left">
              <p className="text-sm text-helb-gold-400 font-medium mb-2">Get In Touch</p>
