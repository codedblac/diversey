...
const faqs: Faq[] = [
  {
    ...
    answer: (
      <ul className="list-disc pl-5 space-y-1">
        ...
        <li>
          Pay registration fee (KES 1,500 individual / KES 5,000 corporate).
        </li>
  ...
  {
    question:
      "What is the difference between share capital, member deposits and saving?",
    answer: (
      <ul className="list-disc pl-5 space-y-1">
        <li>
          <strong>Share capital:</strong> Ownership in the Sacco.
          Non-withdrawable but transferable upon exit.
        </li>
        <li>
          <strong>Member deposits:</strong> Monthly contributions used to
          determine loan eligibility. Earns interest and is refundable.
        </li>
        <li>
          <strong>Savings:</strong> Additional funds deposited voluntarily for
  ...
  },
  {
    ...
    answer:
      "No. It is non-refundable but may be transferred or sold to another Sacco member upon exit.",
  },
  {
    question: "How long does it take a new member to qualify for a loan?",
    answer:
      "At least 3 months of consistent saving, plus meeting the requirements of the specific loan product.",
  },
  {
    question: "How do I make my monthly share contribution and saving?",
    answer:
      "Via bank standing order, direct debits, personal cheques, M-Pesa (Paybill 522522, Account: 1104723948), or employer check-off.",
  },
  {
    question: "Will I continue being a member if I change my employer?",
    answer:
      "Yes. You can continue your membership and contribute monthly while servicing loans.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Yes. Your deposits act as primary security. You’ll also need up to 3 guarantors depending on the loan size.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "You qualify for up to 4× your deposit amount. Deductions should not exceed 2/3 of your salary. Retired members can access 3/4 of their deposits.",
  },
  {
    ...
    answer: (
      <ul className="list-disc pl-5 space-y-1">
        <li>
          The person designated to receive your Sacco benefits in the event of
          your death.
        </li>
  ...
  },
  {
    ...
    answer:
      "Yes, if your savings are higher than your current loans and are uncommitted.",
  },
  {
    question:
      "How long does it take for a member to be refunded deposits after resignation?",
    answer:
      "Up to 2 months. This allows time to clear any pending obligations.",
  },
  {
    question: "Can I change my next of kin/nominee?",
    answer:
      "Yes. Fill in the next of kin or nominee update form to make changes.",
  },
];
...
/>
      ...
      <section className="bg-helb-green-800 text-yellow-300 py-16 text-center">
        ...
        <p className="text-lg">
          Everything you need to know before joining or borrowing
        </p>
      </section>
