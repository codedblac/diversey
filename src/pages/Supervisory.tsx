...
`
  ...
  <div className="flex flex-col items-center gap-12">
    ...
    <div className="flex justify-center gap-6 w-full max-w-md mx-auto">
      <div className="w-[280px]">{renderMemberCard(supervisoryCommittee[0])}</div>
    </div>

    {/* Row 2: 2 members */}
    <div className="flex justify-center gap-6 w-full max-w-[600px] mx-auto">
      {supervisoryCommittee.slice(1, 3).map((member) => (
