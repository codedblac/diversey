...
import { Eye, EyeOff, Lock, User, Mail, Building, Shield, Users, FileText, BarChart3 } from 'lucide-react';
...
const StaffPortal = () => {
  ...
  const handleSignIn = (e: React.FormEvent) => {
    e.preventDefault();
    // Handle staff sign in logic
    console.log('Staff sign in submitted');
  };
      ...
      <section className="bg-helb-green-700 text-white py-16">
        <div className="container mx-auto px-4">
          ...
          <p className="text-center text-lg mt-4 opacity-90">
            Access HELB Sacco's internal systems and management tools
          </p>
        </div>
      </section>
            ...
            <div>
              <Card className="w-full max-w-md mx-auto">
                <CardHeader className="text-center">
                  ...
                  <CardDescription>
                    Access internal systems and member management tools
                  </CardDescription>
                </CardHeader>
                <CardContent>
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="relative">
                        ...
                        <Input
                          id="email"
                          type="email"
                          placeholder="staff@helbsacco.com"
                          className="pl-10"
                          required
                        />
                      </div>
              ...
              <div className="relative">
                ...
                <div className="absolute bottom-6 left-6 text-white">
                  ...
                  <ul className="space-y-2">
                    ...
                    <li className="flex items-center space-x-2">
                      <BarChart3 className="w-5 h-5 text-helb-gold-400" />
